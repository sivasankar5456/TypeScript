/* 
 ...
 the above method is not good to perfom every time we change the ts file, so use following method to automatically change ts file to js file
...
// lesson-1
const character ='siva';
console.log(character)
// note : always add script tag at the end of the body
